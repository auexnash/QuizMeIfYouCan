...
public class MCFourthPage extends javax.swing.JFrame {

    private ArrayList<String> score;
    public MCFourthPage() {
        initComponents();
    }
    public MCFourthPage(ArrayList score) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("a.   8 bits");
        ...
        jRadioButton2.setText(" b.  16 bits");
        ...
        jRadioButton3.setText("c. 32 bits");
        ...
        jRadioButton4.setText("d. 64 bits");
        ...
        jLabel2.setText("4. What is the size of an int in Java?");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(825, 825, 825)
                .addComponent(close, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(layout.createSequentialGroup()
                .addGap(40, 40, 40)
    ...
    private void nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextActionPerformed
        ...
        MCFifthPage mc = new MCFifthPage (score);
        mc.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MCFourthPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MCFourthPage().setVisible(true);
            }
        });
    }
